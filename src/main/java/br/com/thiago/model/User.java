...
public class User implements Serializable, UserDetails {
    ...
    @Column(name = "user_name", unique = true) // unique=true  não pode ter nome de ususario repetido
    ...
    /*
     * Atributos obrigatórios do Spring-security :
     * userName
     * password
     * accountNonExpired
     * accountNonLocked
     ...
     * enabled
     * ------------------------------------------------------
     * menos o fullName foi criado por mim
     */

    @ManyToMany(fetch = FetchType.EAGER)
    @JoinTable(name = "user_permission", joinColumns = {@JoinColumn(name = "is_user")},
