package br.com.thiago.converte;

import br.com.thiago.Converter.DozerConverter;
import br.com.thiago.converte.mocks.MockPerson;
...
public class DozerConverterTest {
    ...
    public void parseEntityToVOTest() {
        ...
        Assert.assertEquals(Long.valueOf(0L), output.getId_chave());
    ...
    public void parseEntityListToVOListTest() {
        ...
        Assert.assertEquals(Long.valueOf(0L), outputZero.getId_chave());
        ...
        Assert.assertEquals(Long.valueOf(7L), outputSeven.getId_chave());
        ...
        Assert.assertEquals(Long.valueOf(12L), outputTwelve.getId_chave());
